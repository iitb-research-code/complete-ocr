...
# VOCABS['odia']      = '-।ଁଂଃଅଆଇଈଉଊଋଏଐଓଔକଖଗଘଙଚଛଜଝଞଟଠଡଢଣତଥଦଧନପଫବଭମଯରଲଳଵଶଷସହ଼ାିୀୁୂୃୄେୈୋୌ୍ୖୗଡ଼ଢ଼ୟୠୡୢୣ୦୧୨୩୪୫୬୭୮୯୰ୱ'
...
# VOCABS['urdu']      = '،ؐؑؒؓؔ؛؟ءآأؤإئابةتثجحخدذرزسشصضطظعغفقكلمنهوىيًٍَُِّْٰٖٗٱٹټپچڈڑژکگںھہۂۃیےۓ۔‌‍‎‏—‘ﷺﺅ'
